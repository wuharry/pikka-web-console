...
import type { ConsoleDataStore, ConsoleService } from "../types";
...
function renderAllMessages(monitorData: ConsoleDataStore): string {
  const allMessages = [
